...
public class Baidu 
{
    ...
    public static void main(String[] args) {
        //Map<String, Double> location ;//= certMonvC2LL(13372307.47, 3514145.00);
        double[] location  = convertLL2MC(121.769716,31.113396);
        System.out.println(location[0]);
        System.out.println(location[1]);
        System.out.println(location[0]*1.19432856685505);
        System.out.println(location[1]*1.19432856685505);
        
        //Double[] res =  APIBaiduUtil.convertLnglat2MC(121.769716,31.113396);
        //Double[] res =  APIBaiduUtil.convertLnglat2MC(121.30716041040203,31.09228717567924);
     ...
     * @return 
     */
    public static double[] convertMC2LL(Double x, Double y) {
        Double[] cF = null;
        x = Math.abs(x);
        y = Math.abs(y);
     ...
     * @return
     */
    public static double[] convertLL2MC(Double lng, Double lat) 
    {
        Double[] cE = null;
